var Menudb = require('../model/model');
...
exports.create = (req,res)=>{
    ...
    item
        ...
        .catch(err =>{
            res.status(500).send({
                message : err.message || "Some error occurred in creating operation"
            });
        });

}

// retrieve and return all Itens/ retrive and return a single item
